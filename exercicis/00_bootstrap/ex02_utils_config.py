# OBJECTIU:
#   Crear el mòdul utils/config.py amb rutes i constants del projecte.
#
# ENTRADA:
#   Cap (crea el fitxer dins utils/)
#
# SORTIDA:
#   utils/config.py amb la configuració completa del curs.
#
# QUÈ APRENEM:
#   - Centralitzar rutes i constants en un sol lloc.
#   - Evitar rutes absolutes i problemes d'encoding.
#   - Fer que tots els scripts comparteixin la mateixa configuració.
...
# Assegurem __init__.py
init_path = utils_dir / "__init__.py"
if not init_path.exists():
    init_path.write_text("# Paquet d'utilitats reutilitzables per als exercicis.\n", encoding="utf-8")

config_content = '''"""Configuració centralitzada (rutes i constants) per al curs PyQGIS."""
...
print("OK -> creat utils/config.py")
print("OK -> utils/__init__.py assegurat")
