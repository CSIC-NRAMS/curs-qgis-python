# OBJECTIU:
#   Crear el mòdul utils/processing_utils.py amb helpers de Processing.
#
# ENTRADA:
#   Cap (crea el fitxer dins utils/)
#
# SORTIDA:
#   utils/processing_utils.py amb funcions reutilitzables.
#
# QUÈ APRENEM:
#   - Envoltar Processing en funcions simples.
#   - Afegir camps i actualitzar valors en capes.
#   - Reutilitzar helpers en exercicis de risc.
...
content = '''"""Utilitats per a QGIS Processing i operacions comunes de capes."""
...
write_text(utils_dir / "processing_utils.py", content)
print("OK -> creat utils/processing_utils.py")
